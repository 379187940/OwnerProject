...
#define DECLARE_JOB_INVOKER_CLASS(name, type, function)                                                                                                                  \
  ...
  public:                                                                                                                                                                \
    ...
    unsigned short GetProfilerIndex() const;                                                                                                                                     \
                                                                                                                                                                         \
    /*******************************************************************/                                                                                                \
  ...
  public:                                                                                                                                                                \
    ...
    void* operator new(size_t nSize)        { return _aligned_malloc(nSize, 128); }                                                                                    \
    void  operator delete(void* pPtr)       { _aligned_free(pPtr); }                                                                                             \
                                                                                                                                                                         \
  ...
  {                                                                                                                                                                      \
    ...
    {                                                                                                                                                                    \
      ...
      gJobHandle ## type = GetJobManagerInterface()->GetJobHandle(name, sizeof(name) - 1, GenerateInvoker(&function));                                                      \
    }                                                                                                                                                                    \
  ...
  {                                                                                                                                                                      \
    ...
    *alias_cast<C**>(m_ParameterStorage) = pClassInstance;                                                                                                               \
                                                                                                                                                                         ...
                                                                                                                                                                         \
  inline unsigned short packet ## type::GetProfilerIndex() const                                                                                                                 \
  {                                                                                                                                                                      \
